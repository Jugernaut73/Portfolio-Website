...
const CertificationCard = ({
  ...
  return (
    <div className="flex flex-1 gap-3 p-2.5 rounded-xl bg-[#2b2b2b]/50 border border-[#302d2d] dark:bg-dark-200 hover:bg-[#2b2b2b] dark:hover:bg-dark-300 hover:border-[#E0E0E0] dark:hover:border-dark-700 transition-colors duration-200">
